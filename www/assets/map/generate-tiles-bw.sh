...
rm *.xml
rm *.vrt
gdal_translate -of VRT -outsize 131072 131072 untiled-bw-x4.png untiled-translated.vrt
...
/home/hutli/gdal/swig/python/gdal-utils/scripts/gdal2tiles.py -p raster -s simple -w leaflet --xyz untiled-translated-warped.vrt tiles-bw